...
#include "irrTypes.h"
extern void IrrFreeSRPObject(void *Object);
extern void IrrGetSRPObjectID(void *Object,void *ObjectID);
extern void *IrrGetSRPObject(void *ObjectID);
	...
	public:
		...
		bool drop() const
		{
			...
			if (!ReferenceCounter)
			{
				...
				ObjectTemp = IrrGetSRPObject( &SRPObjectID );
				if( ObjectTemp != NULL ){
					SetSRPObject( NULL );
					IrrFreeSRPObject( ObjectTemp );
				}
				delete this;
				return true;
			}
		...
		void SetSRPObject(void *Object) const
		{
			IrrGetSRPObjectID( Object, SRPObjectID);
		};
		void *GetSRPObject() const
		{
			return IrrGetSRPObject(SRPObjectID);
		};
