...
//---srplab start
SMaterial* CNullDriver::getMaterial()
{
    return NULL;
}
//---srplab end
...
//---srplab start
ITexture* CNullDriver::getTexture(const io::path& filename,void *Buf,s32 BufSize)
{
	...
	io::IReadFile* file = FileSystem->createMemoryReadFile(Buf, BufSize, filename);
