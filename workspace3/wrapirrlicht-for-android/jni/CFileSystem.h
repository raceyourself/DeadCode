...
//---srplab start
    virtual bool addFileArchive(void* memory, s32 len,const io::path& filename, bool ignoreCase = true, bool ignorePaths = true,E_FILE_ARCHIVE_TYPE archiveType = EFAT_UNKNOWN,const core::stringc& password="");
//---srplab end
