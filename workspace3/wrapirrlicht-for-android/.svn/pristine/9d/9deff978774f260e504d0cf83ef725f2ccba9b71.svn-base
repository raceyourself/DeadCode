...
VS_INT32 SRPCALLBACK IrrQ3LevelMeshClass_OnSystemEvent(VS_ULONG FunctionChoice,void *EventPara)
{
    VS_EVENTPARAM *LocalEventParaPtr;
    struct StructOfIrrQ3LevelMeshClass *IrrQ3LevelMeshClassPtr;
    //VS_EVENTPARAM_RUNPARAM *ResponseParam,*RequestParam;
    //void *ChildObject;
    
    //---------------------------------------------------------------------------
    LocalEventParaPtr = (VS_EVENTPARAM *)EventPara;
    IrrQ3LevelMeshClassPtr = (struct StructOfIrrQ3LevelMeshClass *)LocalEventParaPtr -> DesObject;
...
void *SRPAPI IrrQ3LevelMeshClass_GetShader(void *Object,VS_UINT32 Index)
{
	irr::scene::IQ3LevelMesh* mesh;

	mesh = (irr::scene::IQ3LevelMesh*)IrrObjectClass_GetIrrObject( Object );
	if( mesh == NULL )
		return NULL;
	return (void *)mesh -> getShader(Index);
}

VS_INT32 SRPAPI IrrQ3LevelMeshClass_Lua_GetShader(void)
{
	void *Object;
	VS_INT32 Index;
	void *Shader;
	...
	Index = pSRP -> LuaToInt(2);
    Shader = IrrQ3LevelMeshClass_GetShader( Object, Index );
	pSRP -> LuaPushInt((VS_ULONG)Shader);
	return 1;
}
