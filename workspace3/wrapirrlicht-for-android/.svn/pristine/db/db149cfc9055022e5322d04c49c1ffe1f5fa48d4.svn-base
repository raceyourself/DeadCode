...
public:
	...
	*/
	...
	virtual bool addFileArchive(void* memory, s32 len,const io::path& filename, bool ignoreCase = true, bool ignorePaths = true,E_FILE_ARCHIVE_TYPE archiveType = EFAT_UNKNOWN,const core::stringc& password="") = 0;
  ...
  virtual bool addZipFileArchive(void* memory, s32 len,const c8* filename, bool ignoreCase = true, bool ignorePaths = true)
  {
  	return addFileArchive(memory,len,filename, ignoreCase, ignorePaths, EFAT_ZIP);
  }
